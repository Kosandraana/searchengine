...
//
//    @Override
//    public List<Indexx> getAllIndexxByLemmaId(int lemmaId) {
//        return indexRepository.findByLemmaId(lemmaId);
//    }
//
//    @Override
//    public List<Indexx> getAllIndexxByPageId(int pageId) {
//        return indexRepository.findByPageId(pageId);
//    }
//
//    @Override
//    public synchronized void deleteAllIndexx(List<Indexx> indexxList){
